...
const HUMAN_REPLY_RE = /please reply|please respond|reply with|send me your|share (your )?(resume|availability|phone|rate)|confirm(ing)? your (cell|phone|contact|zip|information)|are you available|available to connect|open to (a )?(quick )?(call|chat|discussion)|quick discussion|schedule a call|when are you free|what is your availability|expected compensation|work authorization|visa status|earliest start/i;
